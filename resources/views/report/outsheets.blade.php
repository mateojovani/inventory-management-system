...
@section('main')
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <br><br>
                            <a href="#" onclick='generate()' class="btn btn-success">{{trans('outputsheet.report.generate')}}</a>
                        </div>
    ...
    <script>
        ...
        function generate()
        {
            ...
            $.ajax({
                url: "{{URL::asset('/report/outsheets')}}",
                type: "POST",
                ...
                success: function (response)
                {
                    if(response == 200)
                    {
                        ...
                        PDFObject.embed('{{URL::asset('/file/report/outputsheet').'/outputsheets.pdf'}}', "#report", options);
                    }
                    else
